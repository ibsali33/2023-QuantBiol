...
Use a Dunnett's test to assess which timepoints are significantly different from the starting time point. Use the starting time point as your control.
