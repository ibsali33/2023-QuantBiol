...
# Use ggplot to create a scatter plot comparing transcriptions and expression signal

ggplot(ProteinExpressionData, aes(x = TranscriptCounts, y = WesternBlotSignal, color = Cluster)) +
  geom_point() +
  labs(title = "Protein expression vs Transcripts (Western Blots)",
       x = "Transcripts Signal",
       y = "Western Signal")
...
Housekeeping <- ProteinExpressionData %>%
  filter(Cluster == "Housekeeping")

# plot the housekeeping genes.
ggplot(Housekeeping, aes(x = TranscriptCounts, y = WesternBlotSignal)) +
  geom_point() +
  labs(title = "Transcription vs Protein Expression",
       x = "Transcription level",
       y = "Expression level (Western Blots)")

# calcluate the correlation coefficient
cor(x = Housekeeping$TranscriptCounts, y = Housekeeping$WesternBlotSignal, method = "pearson")
...
```{r CorTest1, echo = T}
Early <- ProteinExpressionData %>%
  filter(Cluster == "Early")

ggplot(Early, aes(x = TranscriptCounts, y = WesternBlotSignal)) +
  geom_point() +
  labs(x = "Transcription level",
       y = "Expression level")

cor.test(Early$TranscriptCounts, Early$WesternBlotSignal, method = "pearson")
```
...
# scatterplot
ggplot(Early, aes(x = TranscriptCounts, y = FlowCytGFPSignal)) +
  geom_point() +
  labs(x = "Transcription level",
       y = "Expression level")

# correlation test
cor.test(Early$TranscriptCounts, Early$FlowCytGFPSignal, method = "pearson")
...
Late <- ProteinExpressionData %>%
  filter(Cluster == "Late")

ggplot(Late, aes(x = TranscriptCounts, y = WesternBlotSignal)) +
  geom_point() +
  labs(x = "Transcription level",
       y = "Expression level")

cor.test(Late$TranscriptCounts, Late$WesternBlotSignal, method = "pearson")

ggplot(Late, aes(x = TranscriptCounts, y = FlowCytGFPSignal)) +
  geom_point() +
  labs(x = "Transcription level",
       y = "Expression level")

cor.test(Late$TranscriptCounts, Late$FlowCytGFPSignal, method = "pearson")
...
cor.test(Late$TranscriptCounts, Late$WesternBlotSignal, method = "spearman")
...
WesternModel <- lm(formula = TranscriptCounts ~ WesternBlotSignal, data = Early)

# Use summary to obtain the estimates for the parameters a and b, as well as the p-value
summary(WesternModel)
```
## Interpreting `lm()` 
...
ggplot(WesternModel, aes(x = .fitted, y = .resid)) +
  geom_point()+
...
```{r lm3, echo = T}
# Add a gene effect
WesternModel_Time = lm(formula = TranscriptCounts ~ WesternBlotSignal + TimePoint, data = Early)


# Use summary to obtain the estimates for the parameters a and b, as well as the p-value
summary(WesternModel_Time)

# Plot the residuals to (visually) check that the assumptions are verified
ggplot(WesternModel_Time, aes(x = .fitted, y = .resid)) +
  geom_point()+
  geom_hline(yintercept = 0)+
  labs(title = "Residual Plot",
       x = "Mean Counts",
...
# Linear model
FlowCytModel <- lm(formula = TranscriptCounts ~ FlowCytGFPSignal, data = Late)

# Print summary
summary(FlowCytModel)

# Plot the residuals to (visually) check that the assumptions are verified
ggplot(FlowCytModel, aes(x = .fitted, y = .resid)) +
  geom_point()+
  geom_hline(yintercept = 0)+
  labs(title = "Residual Plot",
       x = "Mean Counts",
...
# Linear model
FlowCytModelTime <- lm(formula = TranscriptCounts ~ FlowCytGFPSignal + TimePoint, data = Late)

# Print summary
summary(FlowCytModelTime)

# Plot the residuals to (visually) check that the assumptions are verified
ggplot(FlowCytModelTime, aes(x = .fitted, y = .resid)) +
  geom_point()+
  geom_hline(yintercept = 0)+
  labs(title = "Residual Plot",
       x = "Mean Counts",
